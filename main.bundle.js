...
var EmployeeListComponent = (function () {
    ...
    EmployeeListComponent.prototype.onDelete = function (key) {
        if (confirm('Are you sure to delete this record ?') == true) {
            ...
            this.tostr.warning("Nga lista e punëtorëve", "U fshi me sukses");
        }
    };
...
module.exports = "<form #employeeForm=\"ngForm\" (ngSubmit)=\"onSubmit(employeeForm)\">\r\n    <input type=\"hidden\" name=\"$key\" #$key=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.$key\">\r\n  <div class=\"form-group\">\r\n    <label>Emri</label>\r\n    <input class=\"form-control\" name=\"name\" #name=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.name\" placeholder=\"Emri Mbiemri\" required>\r\n  </div>\r\n  <div class=\"form-group\">\r\n    <label>Pozita</label>\r\n    <input class=\"form-control\" name=\"position\" #position=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.position\" placeholder=\"Pozita\">\r\n  </div>\r\n  <div class=\"form-group\">\r\n    <label>Lokacioni</label>\r\n    <input class=\"form-control\" name=\"office\" #office=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.office\" placeholder=\"Adresa\">\r\n  </div>\r\n  <div class=\"form-group\">\r\n    <label>Paga</label>\r\n    <div class=\"input-group\">\r\n        <div class=\"input-group-addon\">\r\n          <i class=\"fa fa-dollar\"></i>\r\n        </div>\r\n        <input class=\"form-control\" name=\"salary\" #salary=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.salary\" placeholder=\"Paga\">\r\n    </div>\r\n  </div>\r\n  <div class=\"form-group\">\r\n    <button class=\"btn btn-default\" type=\"submit\" [disabled]=\"!employeeForm.valid\">\r\n      <i class=\"fa fa-floppy-o\"></i>\r\n       Ruaj</button>\r\n    <button class=\"btn btn-default\" type=\"button\" (click)=\"resetForm(employeeForm)\">\r\n      <i class=\"fa fa-repeat\"></i>\r\n       Pastro</button>\r\n  </div>\r\n</form>"
...
var EmployeeComponent = (function () {
    ...
    EmployeeComponent.prototype.onSubmit = function (employeeForm) {
        ...
        this.tostr.success('U ruajt me sukses', 'Regjistrimi i Punetorit');
    };
...
module.exports = "<div class=\"text-center\">\r\n  <h2 class=\"jumbotron\">Regjistrimi i Punëtorëve</h2>\r\n</div>\r\n<div class=\"row\">\r\n  <div class=\"col-md-7\">\r\n    <app-employee></app-employee>\r\n  </div>\r\n  <div class=\"col-md-5\">\r\n    <app-employee-list></app-employee-list>\r\n  </div>\r\n</div>"
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyB57eiGM8jmhOIDpP5FvzZsJ1_JmHfKeow",
        authDomain: "klientet-2912c.firebaseapp.com",
        databaseURL: "https://klientet-2912c.firebaseio.com",
        projectId: "klientet-2912c",
        storageBucket: "klientet-2912c.appspot.com",
        messagingSenderId: "892413002654"
    }
};
